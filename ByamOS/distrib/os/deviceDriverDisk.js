...
(function (TSOS) {
    class DeviceDriverDisk extends TSOS.DeviceDriver {
        ...
        translateCharToHexArray(charName) {
        ...
        translateHexArrayToChar(hexArray) {
