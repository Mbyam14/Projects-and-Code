...
//
const APP_NAME: string    = "ByamOS";   
const APP_VERSION: string = "1.01";   
...
var _Status: string = "";                // Inital status is Blank
...
var _DateTime: TSOS.Kernel = null;
var _UserProg: TSOS.Shell = null;
var _DisplaySeg = 1;
